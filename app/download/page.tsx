    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {/* Windows MSI */}
          <a
            href="https://github.com/mrabetmotia/calcul/releases/download/v0.5.0/calcul_0.5.0_x64_en-US.msi"
          ...
          {/* Windows NSIS */}
          <a
            href="https://github.com/mrabetmotia/calcul/releases/download/v0.5.0/calcul_0.5.0_x64-setup.exe"
